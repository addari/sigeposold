  ...
  <div class="portlet-content">
      <ul class="nav nav-pills">
        ...
        <li class="active"><a href="#"><i class="icon-edit"></i> Modificar</a><li>
                <li><a href="<?php echo url_for('adm_ma_emp_users_r/show?id='.$adm_ma_emp_users_r->getId()) ?>"><i class="icon-eye-open"></i> Ver</a></li>
      </li>
    </ul>
  </div>
</div>
...
<?php include_partial('form', array("form" => $form, "accion_formulario" => "Editar Empresa")) ?>
</div>
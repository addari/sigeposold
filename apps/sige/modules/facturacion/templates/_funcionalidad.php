...
App.Facturacion.View.ContenedorFactura = Backbone.View.extend({
	...
	showModalItems: function(event){
		...
		var output = App.Helpers.Mensaje({tipo:"error",mensaje: "Debe seleccionar los datos del cliente."}),
	...
	$("#factura_fecha_emision")
		...
		.on('changeDate', function(ev){
			var sfechaFinal  = $("#factura_fecha_vencimiento").val(),
				...
				output = App.Helpers.Mensaje({tipo:"error",mensaje: "Rango de fecha invalido."});

...
/**
 * AdmMaDocsT form base class.
 *
 * @method AdmMaDocsT getObject() Returns the current form's model object
 *
 * @package    sige
 * @subpackage form
 ...
 */
abstract class BaseAdmMaDocsTForm extends BaseFormDoctrine
{

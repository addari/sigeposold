...
/**
 * AdmMaDocsT filter form base class.
 *
 * @package    sige
 * @subpackage filter
 ...
 */
abstract class BaseAdmMaDocsTFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('adm_ma_docs_t_filters[%s]');

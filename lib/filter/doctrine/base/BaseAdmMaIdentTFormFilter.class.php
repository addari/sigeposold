...
/**
 * AdmMaIdentT filter form base class.
 *
 * @package    sige
 * @subpackage filter
 ...
 */
abstract class BaseAdmMaIdentTFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('adm_ma_ident_t_filters[%s]');
